...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.output = nn.Sequential(
            nn.Linear(64 * 5 * 5, 120), nn.ReLU(), nn.Dropout(0.1), nn.Linear(120, 78)
        )
...
def img2emnist(filepath, char_code):
    """
    Prende l'immagine (segmentata direi), fa sharpening e
    la associa al char corrispondente (da dove arriva e com'è fatto?)
    """
